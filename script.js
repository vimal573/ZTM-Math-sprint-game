...
// Check Local Storage for Best Scores, st bestScoreArray
...
function updateBestScore() {
  bestScoreArray.forEach((scorePage, index) => {
...
// From that decides amount if questions
